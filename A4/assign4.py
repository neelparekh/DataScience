...
if __name__ == '__main__':
	...
	parser.add_argument('--data', default=os.path.expanduser(os.path.join(mydir,'data/stanfordSentimentTreebank')), type=str)
	parser.add_argument('--embeddings', default=os.path.expanduser(os.path.join(mydir,'data/glove/glove.840B.300d.txt')), type=str)
